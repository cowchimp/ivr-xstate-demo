...
module.exports = Machine({
  ...
  states: {
    ...
    mainStReservation: {
      meta: {
        ncco: [
          { action: 'talk', text: 'Transferring you to take your reservation.' },
          { action: 'connect', from: '15557654321', endpoint: [{ type: 'phone', number: '15551357913' }] }
        ]
      }
    },
    mainStHours: {
    ...
    broadwayReservation: {
      meta: {
        ncco: [
          { action: 'talk', text: 'Transferring you to take your reservation.' },
          { action: 'connect', from: '15557654321', endpoint: [{ type: 'phone', number: '15552468024' }] }
        ]
      }
    },
    broadwayHours: {
      ...
      meta: {
        ncco: [
          { action: 'talk', text: "Joe's Broadway is open Monday through Sunday, 10am to 11pm." },
          { action: 'talk', text: 'Press 1 to hear this information again.' },
          { action: 'talk', text: 'Press 2 to make a reservation.' },
